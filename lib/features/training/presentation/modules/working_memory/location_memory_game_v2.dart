...
/// 위치 기억 게임 (WM-09) - JSON 기반 버전
class LocationMemoryGameV2 extends StatefulWidget {
  final String childId;
  final void Function(bool isCorrect, int responseTimeMs) onAnswer;
  final VoidCallback? onComplete;
  final int difficultyLevel;

  const LocationMemoryGameV2({
    super.key,
  ...
  @override
  State<LocationMemoryGameV2> createState() => _LocationMemoryGameV2State();
}

class _LocationMemoryGameV2State extends State<LocationMemoryGameV2> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final content = await _loaderService.loadFromLocalJson('location_memory.json');
        ...
        Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Text('📍 어디 있었나요?', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
