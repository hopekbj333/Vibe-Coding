...
/// 숫자 폭 기억 게임 (WM-06) - JSON 기반 버전
/// 
/// 숫자를 듣고 똑같이 말하거나 선택합니다.
class DigitSpanGameV2 extends StatefulWidget {
  final String childId;
  final void Function(bool isCorrect, int responseTimeMs) onAnswer;
  final VoidCallback? onComplete;
  final int difficultyLevel;

  const DigitSpanGameV2({
    super.key,
  ...
  @override
  State<DigitSpanGameV2> createState() => _DigitSpanGameV2State();
}

class _DigitSpanGameV2State extends State<DigitSpanGameV2> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final content = await _loaderService.loadFromLocalJson('digit_span.json');
  ...
  Widget build(BuildContext context) {
    ...
    final digits = currentItem.itemData?['digits'] as List?;
      ...
      children: [
        Column(
          ...
          children: [
            ...
            // 지시문
            const Text('🔢 숫자를 기억하세요!', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ...
            Container(
              ...
              child: Text(currentItem.question, style: const TextStyle(fontSize: 56, fontWeight: FontWeight.bold, letterSpacing: 8)),
            ),
            ...
            if (!_showAnswer && !_answered)
              ElevatedButton(
                ...
                child: const Text('정답 확인하기', style: TextStyle(fontSize: 20, color: Colors.white)),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(currentItem.correctAnswer, style: const TextStyle(fontSize: 40, fontWeight: FontWeight.bold, letterSpacing: 8)),
                  ],
                ),
              ),
