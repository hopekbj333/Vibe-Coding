...
/// 지시 따르기 게임 (WM-02) - JSON 기반 버전
/// 
/// 지시를 듣고 올바른 도형/색상을 선택합니다.
class InstructionFollowGameV2 extends StatefulWidget {
  final String childId;
  final void Function(bool isCorrect, int responseTimeMs) onAnswer;
  final VoidCallback? onComplete;
  final int difficultyLevel;

  const InstructionFollowGameV2({
    super.key,
  ...
  @override
  State<InstructionFollowGameV2> createState() => _InstructionFollowGameV2State();
}

class _InstructionFollowGameV2State extends State<InstructionFollowGameV2> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final content = await _loaderService.loadFromLocalJson('instruction_follow.json');
        ...
        Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Text('🎯 지시를 듣고 고르세요!', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
