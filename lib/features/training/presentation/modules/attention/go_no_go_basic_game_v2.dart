...
/// Go/No-Go 기본 게임 (AT-10) - JSON 기반 버전
class GoNoGoBasicGameV2 extends StatefulWidget {
  final String childId;
  final void Function(bool isCorrect, int responseTimeMs) onAnswer;
  final VoidCallback? onComplete;
  final int difficultyLevel;

  const GoNoGoBasicGameV2({
    super.key,
  ...
  @override
  State<GoNoGoBasicGameV2> createState() => _GoNoGoBasicGameV2State();
}

class _GoNoGoBasicGameV2State extends State<GoNoGoBasicGameV2> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final content = await _loaderService.loadFromLocalJson('go_no_go_basic.json');
  ...
  void _onOptionSelected(int index) {
    ...
    final isCorrect = currentItem.correctAnswer.contains(selectedOption.optionId);
        ...
        Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Text('🎯 지시에 맞는 것만 터치!', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ...
            Expanded(
              child: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: currentItem.options.length > 3 ? 2 : 3,
                  mainAxisSpacing: 16,
                  crossAxisSpacing: 16,
                  childAspectRatio: 1,
                ),
