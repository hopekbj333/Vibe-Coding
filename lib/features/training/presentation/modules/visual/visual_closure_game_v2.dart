...
class VisualClosureGameV2 extends StatefulWidget {
  final String childId;
  final void Function(bool isCorrect, int responseTimeMs) onAnswer;
  final VoidCallback? onComplete;
  final int difficultyLevel;
  const VisualClosureGameV2({super.key, required this.childId, required this.onAnswer, this.onComplete, this.difficultyLevel = 1});
  @override
  State<VisualClosureGameV2> createState() => _VisualClosureGameV2State();
}

class _VisualClosureGameV2State extends State<VisualClosureGameV2> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final content = await _loaderService.loadFromLocalJson('visual_closure.json');
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Text('🔍 일부만 보고 맞춰보세요!', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    const Text('일부만 보임 ↓', style: TextStyle(fontSize: 14, color: Colors.grey, fontWeight: FontWeight.bold)),
              ...
              const SizedBox(height: 24),
              const Text('전체는 무엇일까요?', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              // GridView를 고정 높이로
              SizedBox(
                height: 300,
  ...
  Widget _buildOptionCard(int index) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(child: Text(option.label, style: const TextStyle(fontSize: 32))),
      ),
    );
  }
