...
/// 시각 추적 게임 (V-09) - JSON 기반 버전
class VisualTrackingGameV2 extends StatefulWidget {
  final String childId;
  final void Function(bool isCorrect, int responseTimeMs) onAnswer;
  final VoidCallback? onComplete;
  final int difficultyLevel;

  const VisualTrackingGameV2({
    super.key,
  ...
  @override
  State<VisualTrackingGameV2> createState() => _VisualTrackingGameV2State();
}

class _VisualTrackingGameV2State extends State<VisualTrackingGameV2> {
  ...
  Future<void> _loadQuestions() async {
    try {
      final content = await _loaderService.loadFromLocalJson('visual_tracking.json');
        ...
        Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Text('👁️ 경로를 따라가세요!', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
