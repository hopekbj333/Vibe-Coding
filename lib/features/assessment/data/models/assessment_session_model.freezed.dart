...
mixin _$AssessmentSession {
  ...
  @JsonKey(
      toJson: _assessmentQuestionsToJson,
      fromJson: _assessmentQuestionsFromJson)
  List<AssessmentQuestion> get questions; // 전체 문항 (50개)
  ...
  $AssessmentSessionCopyWith<AssessmentSession> get copyWith =>
      _$AssessmentSessionCopyWithImpl<AssessmentSession>(
          this as AssessmentSession, _$identity);
...
abstract mixin class $AssessmentSessionCopyWith<$Res> {
  factory $AssessmentSessionCopyWith(
          AssessmentSession value, $Res Function(AssessmentSession) _then) =
      _$AssessmentSessionCopyWithImpl;
  @useResult
  $Res call(
      {String sessionId,
      String childId,
...
extension AssessmentSessionPatterns on AssessmentSession {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AssessmentSession value)? $default, {
...
class _AssessmentSession extends AssessmentSession {
  const _AssessmentSession(
      ...
      @JsonKey(
          toJson: _assessmentQuestionsToJson,
          fromJson: _assessmentQuestionsFromJson)
      required final List<AssessmentQuestion> questions,
      required final List<AssessmentAnswer> answers,
      required this.currentQuestionIndex,
      required this.totalQuestions})
      : _questions = questions,
        _answers = answers,
        super._();
  factory _AssessmentSession.fromJson(Map<String, dynamic> json) =>
...
// 현재 문항 번호 (0-based)
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AssessmentSessionCopyWith<_AssessmentSession> get copyWith =>
      __$AssessmentSessionCopyWithImpl<_AssessmentSession>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AssessmentSessionToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AssessmentSessionCopyWith<$Res>
    implements $AssessmentSessionCopyWith<$Res> {
  factory _$AssessmentSessionCopyWith(
          _AssessmentSession value, $Res Function(_AssessmentSession) _then) =
      __$AssessmentSessionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String sessionId,
...
mixin _$AssessmentAnswer {
  ...
  $AssessmentAnswerCopyWith<AssessmentAnswer> get copyWith =>
      _$AssessmentAnswerCopyWithImpl<AssessmentAnswer>(
          this as AssessmentAnswer, _$identity);
...
abstract mixin class $AssessmentAnswerCopyWith<$Res> {
  factory $AssessmentAnswerCopyWith(
          AssessmentAnswer value, $Res Function(AssessmentAnswer) _then) =
      _$AssessmentAnswerCopyWithImpl;
  @useResult
  $Res call(
      {int questionIndex,
      String questionId,
...
extension AssessmentAnswerPatterns on AssessmentAnswer {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AssessmentAnswer value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
// 답변 시간
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AssessmentAnswerCopyWith<_AssessmentAnswer> get copyWith =>
      __$AssessmentAnswerCopyWithImpl<_AssessmentAnswer>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AssessmentAnswerToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AssessmentAnswerCopyWith<$Res>
    implements $AssessmentAnswerCopyWith<$Res> {
  factory _$AssessmentAnswerCopyWith(
          _AssessmentAnswer value, $Res Function(_AssessmentAnswer) _then) =
      __$AssessmentAnswerCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int questionIndex,
