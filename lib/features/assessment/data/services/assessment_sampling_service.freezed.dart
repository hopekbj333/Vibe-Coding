...
mixin _$AssessmentQuestion {
 ...
 String get contentId; TrainingContentType get type; GamePattern get pattern; String get itemId; String get question; List<ContentOption> get options; String get correctAnswer; DifficultyParams? get difficulty;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,questionNumber,gameId,gameTitle,contentId,type,pattern,itemId,question,const DeepCollectionEquality().hash(options),correctAnswer,difficulty);
...
@useResult
$Res call({
 int questionNumber, String gameId, String gameTitle, String contentId, TrainingContentType type, GamePattern pattern, String itemId, String question, List<ContentOption> options, String correctAnswer, DifficultyParams? difficulty
});
...
/// Create a copy of AssessmentQuestion
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? questionNumber = null,Object? gameId = null,Object? gameTitle = null,Object? contentId = null,Object? type = null,Object? pattern = null,Object? itemId = null,Object? question = null,Object? options = null,Object? correctAnswer = null,Object? difficulty = freezed,}) {
...
as TrainingContentType,pattern: null == pattern ? _self.pattern : pattern // ignore: cast_nullable_to_non_nullable
as GamePattern,itemId: null == itemId ? _self.itemId : itemId // ignore: cast_nullable_to_non_nullable
as String,question: null == question ? _self.question : question // ignore: cast_nullable_to_non_nullable
as String,options: null == options ? _self.options : options // ignore: cast_nullable_to_non_nullable
as List<ContentOption>,correctAnswer: null == correctAnswer ? _self.correctAnswer : correctAnswer // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int questionNumber,  String gameId,  String gameTitle,  String contentId,  TrainingContentType type,  GamePattern pattern,  String itemId,  String question,  List<ContentOption> options,  String correctAnswer,  DifficultyParams? difficulty)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AssessmentQuestion() when $default != null:
return $default(_that.questionNumber,_that.gameId,_that.gameTitle,_that.contentId,_that.type,_that.pattern,_that.itemId,_that.question,_that.options,_that.correctAnswer,_that.difficulty);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int questionNumber,  String gameId,  String gameTitle,  String contentId,  TrainingContentType type,  GamePattern pattern,  String itemId,  String question,  List<ContentOption> options,  String correctAnswer,  DifficultyParams? difficulty)  $default,) {final _that = this;
switch (_that) {
case _AssessmentQuestion():
return $default(_that.questionNumber,_that.gameId,_that.gameTitle,_that.contentId,_that.type,_that.pattern,_that.itemId,_that.question,_that.options,_that.correctAnswer,_that.difficulty);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int questionNumber,  String gameId,  String gameTitle,  String contentId,  TrainingContentType type,  GamePattern pattern,  String itemId,  String question,  List<ContentOption> options,  String correctAnswer,  DifficultyParams? difficulty)?  $default,) {final _that = this;
switch (_that) {
case _AssessmentQuestion() when $default != null:
return $default(_that.questionNumber,_that.gameId,_that.gameTitle,_that.contentId,_that.type,_that.pattern,_that.itemId,_that.question,_that.options,_that.correctAnswer,_that.difficulty);case _:
  return null;
...
class _AssessmentQuestion implements AssessmentQuestion {
  const _AssessmentQuestion({required this.questionNumber, required this.gameId, required this.gameTitle, required this.contentId, required this.type, required this.pattern, required this.itemId, required this.question, required final  List<ContentOption> options, required this.correctAnswer, this.difficulty}): _options = options;
...
@override final  TrainingContentType type;
@override final  GamePattern pattern;
@override final  String itemId;
@override final  String question;
 final  List<ContentOption> _options;
@override List<ContentOption> get options {
...
@override final  DifficultyParams? difficulty;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,questionNumber,gameId,gameTitle,contentId,type,pattern,itemId,question,const DeepCollectionEquality().hash(_options),correctAnswer,difficulty);
...
/// Create a copy of AssessmentQuestion
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? questionNumber = null,Object? gameId = null,Object? gameTitle = null,Object? contentId = null,Object? type = null,Object? pattern = null,Object? itemId = null,Object? question = null,Object? options = null,Object? correctAnswer = null,Object? difficulty = freezed,}) {
